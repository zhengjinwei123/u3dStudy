...
public class UIManager : BaseManager {
	...
	public UIManager(GameFacade facase) : base(facase)
    {
	...
	public override void Update()
	{
		if (panelTypeToPush != UIPanelType.None) {
			Debug.Log("zjw called:" + panelTypeToPush);
    ...
    private BasePanel GetPanel(UIPanelType panelType)
    {
        ...
        if (panel == null)
        {
			...
			instPanel.GetComponent<BasePanel>().Facade = gameFacade;
	...
	public void InjectMsgPanel(MessagePanel panel) {
		this.msgPanel = panel;
	}

	public void ShowMessage(string msg) {
		if (msgPanel == null) {
			Debug.Log("ShowMessage msg panel 是 null"); return;
		}
	...
	public void ShowMessageASync(string msg)
	{
		if (msgPanel == null)
		{
			Debug.Log("ShowMessageASync msg panel 是 null"); return;
		}
